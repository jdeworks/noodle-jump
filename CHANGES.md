...
- progress: Ghost tinting (orange/green), spectate after death, auto-aim shooting (E/Q and Space), mode selection in lobby, Escape to forfeit online, FPS debug-only | src/multiplayer/RemotePlayerRenderer.ts, src/multiplayer/OnlineSession.ts, src/multiplayer/LocalCoopLauncher.ts, src/multiplayer/LocalInput.ts, src/multiplayer/ResultsScreen.ts, src/multiplayer/LobbyScreen.ts, src/scenes/GameScene.ts
