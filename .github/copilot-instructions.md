Read `AGENTS.md` and follow the instructions there. That is the single source of truth for this project.

## Progress tracking (no hooks — you must do this yourself)

GitHub Copilot has no lifecycle hooks. You MUST manually follow these steps:
