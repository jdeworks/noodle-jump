...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    id: "meatball_10",
    name: "Meatball Snack",
    description: "Collect 10 meatballs total",
    condition: (s) => s.totalMeatballs >= 10,
  },
  {
    id: "meatball_100",
    name: "Meatball Mania",
    description: "Collect 100 meatballs total",
    condition: (s) => s.totalMeatballs >= 100,
  },
  {
    id: "meatball_1000",
    name: "Meatball Mogul",
    description: "Collect 1000 meatballs total",
    condition: (s) => s.totalMeatballs >= 1000,
  },
  {
    id: "meatball_5000",
    name: "Meatball Emperor",
    description: "Collect 5000 meatballs total",
  ...
  // Height milestones
  {
    ...
    description: "Reach height 100",
    condition: (s) => s.bestHeight >= 100,
  },
  {
    id: "height_500",
    name: "Sky High",
    description: "Reach height 500",
    condition: (s) => s.bestHeight >= 500,
  },
  {
    id: "height_1000",
    name: "Stratosphere",
    description: "Reach height 1000",
    condition: (s) => s.bestHeight >= 1000,
  },
  {
    id: "height_2000",
    name: "Cloud Surfer",
    description: "Reach height 2000",
  ...
  // Zone milestones
  {
    id: "zone_2",
    name: "Deep Diver",
    description: "Reach the Boiling Pot zone",
    condition: (s) => s.maxZone >= 1,
  },
  {
    id: "zone_3",
    name: "Space Chef",
    description: "Reach Space",
    condition: (s) => s.maxZone >= 2,
  },
  {
    id: "zone_4",
    name: "Ice Cold",
    description: "Reach the Freezer",
    condition: (s) => s.maxZone >= 3,
  },
  {
    id: "zone_5",
    name: "Hot Stuff",
    description: "Reach the Volcano",
    condition: (s) => s.maxZone >= 4,
  },
  {
    id: "zone_6",
    name: "Sweet Tooth",
    description: "Reach Candy World",
    condition: (s) => s.maxZone >= 5,
  },
  {
    id: "zone_7",
    name: "Grand Chef",
    description: "Reach the Final Kitchen",
  ...
  // Per-game achievements
  {
    id: "perfect_start",
    name: "Perfect Start",
    description: "Reach height 50 with a 10+ streak",
  ...
  },
  {
    id: "enemy_slayer_10",
    name: "Exterminator",
    description: "Kill 10 enemies in one game",
  ...
  },
  {
    id: "boss_defeated_3",
    name: "Boss Hunter",
    description: "Defeat 3 bosses total",
    condition: (s) => s.totalBossesDefeated >= 3,
  },
  {
    id: "boss_stomp",
    name: "Head Bounce",
    description: "Stomp on a boss",
  ...
  },
  {
    id: "no_miss_50",
    name: "Perfect Run",
    description: "Land 50 platforms in a row",
  ...
  },
  {
    id: "daily_diamond",
    name: "Diamond Chef",
    description: "Earn diamond on a daily challenge",
    condition: (_, g) => g?.dailyMedal === "diamond",
  },
  {
    id: "daily_week_medals",
    name: "Medal Collector",
    description: "Earn all 3 medal types in one week",
