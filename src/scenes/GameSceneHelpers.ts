...
export function buildRenderContext(c: SceneComponents): RenderContext {
  return {
    state: c.state,
    camY: c.state.camera.y,
    interpPlayerX: c.state.player.x,
    interpPlayerY: c.state.player.y,
    parallax: c.parallax,
    particles: c.particles,
    effectRenderer: c.effectRenderer,
    gfxSync: c.gfxSync,
    trail: c.trail,
    floatingTextMgr: c.floatingTextMgr,
    gameContainer: c.gameContainer,
    playerGfx: c.playerGfx,
    weatherContainer: c.weatherContainer,
    weatherGfx: c.weatherGfx,
    windGfx: c.windGfx,
    bossGfx: c.bossGfx,
    bossArcGfx: c.bossArcGfx,
    bossHealthGfx: c.bossHealthGfx,
    bossAttackGfx: c.bossAttackGfx,
    knifeAmmoText: c.knifeAmmoText,
    knifeAmmoIcons: c.knifeAmmoIcons,
    hitboxGfx: c.hitboxGfx,
    tentacleGfx: c.tentacleGfx,
    comboGlowGfx: c.comboGlowGfx,
    cosmeticTrail: c.cosmeticTrail,
    cosmeticTint: c.cosmeticTint,
    cosmeticTheme: c.cosmeticTheme,
    inputX: c.inputX,
  };
}
...
export function buildEventDeps(c: SceneComponents): EventHandlerDeps {
  return {
    ...
    particles: c.particles,
    effectRenderer: c.effectRenderer,
    zoneTransition: c.zoneTransition,
    gfxSync: c.gfxSync,
